<?php
/**
 * สร้างตาราง returned_items โดยเหมาะสมกับโครงสร้างจริง
 */
...
try {
    ...
    echo "<h2>🗑️ ขั้นตอนที่ 1: ลบตารางเก่า</h2>";
    ...
    echo "<h2>✨ ขั้นตอนที่ 2: สร้างตารางใหม่</h2>";
    
    // สร้าง return_reasons
    ...
    // สร้าง returned_items โดยไม่มี FK กับ products (เพราะ products ไม่มี PK กำหนด)
    $sql_items = "CREATE TABLE `returned_items` (
      ...
      `product_id` int(11) NOT NULL COMMENT 'product_id (ไม่มี FK เพราะ products ไม่มี PK)',
    ...
    echo "<hr style='margin: 2rem 0;'>";
    echo "<h2>📝 ขั้นตอนที่ 3: เพิ่มเหตุผลการตีกลับ</h2>";
    ...
    echo "<p style='color: #2e7d32; margin-bottom: 0.5rem;'>ตารางสามารถใช้งานได้ทันที</p>";
    echo "<p style='color: #2e7d32; margin-bottom: 0; font-size: 0.9rem;'>";
    echo "<strong>หมายเหตุ:</strong> ไม่มี FK กับ products เพราะตาราง products ไม่มี PRIMARY KEY กำหนดในฐานข้อมูล";
    echo "</p>";
    echo "</div>";
